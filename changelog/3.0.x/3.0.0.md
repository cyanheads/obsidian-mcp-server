...
| `obsidian_list_notes` | `obsidian_list_files` (same extension and name-regex filters; result echoes `appliedFilters`). Returns separate `files[]` and `directories[]` arrays — v2's nested tree-view rendering is gone. |
